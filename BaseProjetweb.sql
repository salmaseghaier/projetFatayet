...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 28 juin 2024 à 17:02
...
INSERT INTO `paiement` (`id`, `numerocarte`, `code`, `idCmd`) VALUES
(1, 2147483647, 0, 0),
(2, 2147483643, 0, 0),
(3, 2147483640, 0, 0);
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`idPaim`) REFERENCES `paiement` (`id`),
